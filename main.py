        ...
        try:
            ...
            if '.' in self.input.text():
                try:
                    ...
                    self.input.setText('В строке несколько запятых')
            else:
                self.input.setText('В строке есть буква или неиспользуемый символ')
        ...
        try:
            if self.op == '+':
                ...
                try:
                    ...
                    self.input.setText('Деление на 0')
                    del self.num_1
            elif self.op == '*':
                self.input.setText((str(self.num_1 * self.num_2)))
                del self.num_1
        except AttributeError:
            self.input.setText('Строка пуста или не имеет смысла')
